#!/usr/bin/env bash
#Petit script pour exécuter un rsync entre la source et le remote via le port 2222, pour le rsync du PBS sur le Synogmère
#zf251107.1633, zf251209.0951, zf260711.1458
